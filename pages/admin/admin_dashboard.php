...
.admin-panel { max-width:1200px; margin:40px auto; padding:20px }
.top-bar { display:flex; justify-content:space-between; align-items:center }
.btn { padding:8px 14px; border-radius:6px; text-decoration:none; font-weight:600 }
.btn-add { background:#28a745; color:white }
.btn-logout { background:#dc3545; color:white }
.stat-box { background:white; padding:15px; border-radius:10px; margin:10px; display:inline-block }
.card { background:white; padding:15px; border-radius:10px; margin-bottom:15px }
.btn-delete { background:#FF6600; color:white; border:none; padding:6px 10px; border-radius:5px }
</style>
</head>
